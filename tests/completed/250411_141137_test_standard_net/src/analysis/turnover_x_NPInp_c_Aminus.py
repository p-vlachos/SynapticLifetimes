...
if __name__ == "__main__":
    ...
    for bpath in build_dirs:
        ...
        try:
            ...
            Aminus_list.append(nsp['Aminus'])

        except FileNotFoundError:
            print(bpath[-4:], "reports: No namespace data. Skipping.")

    Aminus_list = list(set(Aminus_list))

    print(Aminus_list)
    

    for Aminus in Aminus_list:
        ...
        directory = 'figures/turnover_x_NPInp_c_Aminus'
        if fit:
            directory += '_fit'
        ...
        fname = "trn_binw%ds_starter-%s_tcut%ds_Aminus%.7f" %(int(bin_w/second),
                                                              starters,
                                                              int(t_cut/second),
                                                              Aminus)
