...
def yasumatsu_plot(bpath, nsp):
    ...
    try:
        ...
        for j,(tstart,tstop) in enumerate([(-10,-1), (-5,-1), (-2,-1)]):
            ...
            axes[0,j].scatter(weight_tstart_slct, weight_dt_slct, marker='o',
            ...
            axes[1,j].scatter(weight_tstart_slct,
        ...
        for j,(tstart,tstop) in enumerate([(10,19), (10,14), (10,11)]):
            ...
            axes[2,j].scatter(weight_tstart_slct, weight_dt_slct, marker='o',
                              lw=0, s=(72./fig.dpi)**2, label=label)
