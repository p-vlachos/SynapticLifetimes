...
def overview_figure(bpath, nsp):
    ...
    contacts_per_neuron_histogram(axs['1,1'], bpath, nsp, cn='EE')
    contacts_per_neuron_histogram(axs['1,2'], bpath, nsp, cn='EI')

    contacts_per_neuron_histogram(axs['2,1'], bpath, nsp, cn='EE', ztype='out')
    contacts_per_neuron_histogram(axs['2,2'], bpath, nsp, cn='EI', ztype='out')
    
    connection_count_correlation(axs['3,1'], bpath, nsp, cn1='EE')
    connection_count_correlation(axs['3,3'], bpath, nsp, cn1='EE', cn2='EI')
    connection_weight_correlation(axs['3,4'], bpath, nsp, cn1='EE', cn2='EI')
    ...
    directory = "figures/connection_stats"
